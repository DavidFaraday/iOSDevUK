...
struct DummyData {
    ...
    static let informationItems = [
        ...
        InformationItem(id: UUID().uuidString, name: "Accommodation", link: "http://users.aber.ac.uk/nst/iosdevuk/jump.php?to=accommodation"),
        InformationItem(id: UUID().uuidString, name: "Parking", link: "http://users.aber.ac.uk/nst/iosdevuk/jump.php?to=parking"),
        InformationItem(id: UUID().uuidString, name: "University Information", link: "http://users.aber.ac.uk/nst/iosdevuk/jump.php?to=university")
    ]
